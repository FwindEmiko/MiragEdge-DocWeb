---
title: 开发文档中心
description: 锐界幻境服务器开发文档中心：插件配置教程（自定义作物/钓鱼/附魔）、玩法设计方案、网站开发组件、更新日志与节点状态，助力团队高效协作开发。
head:
  - - meta
    - name: keywords
      content: 锐界幻境开发, Minecraft 服务器开发, 插件配置, 开发文档, 开发团队, 教程
---
...
| 插件 | 说明 | 文档 |
|------|------|------|
| EMCShop | 等价交换商店，集成物品银行系统，支持物品与货币双向兑换 | [EMCShop 文档](/plugins/custom/emc-shop) |
| FE_Fly | 幻空翼飞行，限时飞行权限管理系统，支持飞行时长配置 | [历史文档](/developer/archive/plugins/fe-fly) |
