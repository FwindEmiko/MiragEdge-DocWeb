---
title: SkyElytra 幻空翼飞行系统插件
description: SkyElytra 为 Paper 1.21.11 服务端打造的精细化飞行管理插件：为建筑玩家提供领地内平衡可控的无限飞行，为冒险玩家提供幻空翼、经验双模式限时飞行与粒子特效。
head:
  - - meta
    - name: keywords
      content: SkyElytra, 幻空翼, Minecraft 飞行插件, Paper 插件, 飞行管理, 鞘翅飞行
---
