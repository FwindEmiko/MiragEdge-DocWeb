...
const prefixRules: PrefixRule[] = [
  ...
  ['/develop', '/developer'],
  ['/plugins/fepvp', '/developer/archive/plugins/pvp'],
  ['/plugins/pvp', '/developer/archive/plugins/pvp'],
...
const exactRules: RedirectRule[] = [
  ...
  { from: '/plugins/fepvp', to: '/developer/archive/plugins/pvp' },
  { from: '/plugins/pvp', to: '/developer/archive/plugins/pvp' },
