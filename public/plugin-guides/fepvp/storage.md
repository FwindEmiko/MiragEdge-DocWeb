<!-- 来源页面: https://miragedge.top/plugin-guides/fepvp/storage -->
<!-- 由 llms.txt 标准生成器自动产出，源文件: plugin-guides/fepvp/storage.md -->
...
详见 [竞技场管理 — arenas.yml 存储格式](https://miragedge.top/plugin-guides/fepvp/arena.md#arenasyml-存储格式)。

## kits.yml 格式

详见 [装备组合管理 — kits.yml 存储格式](https://miragedge.top/plugin-guides/fepvp/kit.md#kitsyml-存储格式)。
