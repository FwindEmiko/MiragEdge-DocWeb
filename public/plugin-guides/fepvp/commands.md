<!-- 来源页面: https://miragedge.top/plugin-guides/fepvp/commands -->
<!-- 由 llms.txt 标准生成器自动产出，源文件: plugin-guides/fepvp/commands.md -->
...
| 命令 | 权限 | 说明 |
|------|------|------|
| `/fepvp admin arena create <名称> ` | `fepvp.admin` | 创建竞技场 |
...
| `/fepvp admin arena settype <名称> ` | `fepvp.admin` | 修改竞技场类型 |
| `/fepvp admin arena setmaxplayers <名称> <人数>` | `fepvp.admin` | 设置每队最大人数 |
| `/fepvp admin arena setmode <名称> ` | `fepvp.admin` | 设置团队模式 |
