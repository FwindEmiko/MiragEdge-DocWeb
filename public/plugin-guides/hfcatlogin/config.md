<!-- 来源页面: https://miragedge.top/plugin-guides/hfcatlogin/config -->
<!-- 由 llms.txt 标准生成器自动产出，源文件: plugin-guides/hfcatlogin/config.md -->
...
未认证玩家可执行的命令（见[权限节点](https://miragedge.top/plugin-guides/hfcatlogin/permissions)）：
