<!-- 来源页面: https://miragedge.top/plugin-guides/fe-back -->
<!-- 由 llms.txt 标准生成器自动产出，源文件: plugin-guides/fe-back/index.md -->
...
这套文档按实际部署结构整理：玩家先看[玩家指南](https://miragedge.top/plugin-guides/fe-back/guide)，服主和维护者可继续查阅[命令参考](https://miragedge.top/plugin-guides/fe-back/commands)、[配置参考](https://miragedge.top/plugin-guides/fe-back/config)、[权限节点](https://miragedge.top/plugin-guides/fe-back/permissions)与[数据存储](https://miragedge.top/plugin-guides/fe-back/storage)。
...
- [玩家指南](https://miragedge.top/plugin-guides/fe-back/guide)
- [命令参考](https://miragedge.top/plugin-guides/fe-back/commands)
- [配置参考](https://miragedge.top/plugin-guides/fe-back/config)
- [权限节点](https://miragedge.top/plugin-guides/fe-back/permissions)
- [数据存储](https://miragedge.top/plugin-guides/fe-back/storage)
- 玩家向说明页：[死亡回程](https://miragedge.top/plugins/custom/death-return)
- [经济系统](https://miragedge.top/play/systems/economy)
