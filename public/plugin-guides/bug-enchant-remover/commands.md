<!-- 来源页面: https://miragedge.top/plugin-guides/bug-enchant-remover/commands -->
<!-- 由 llms.txt 标准生成器自动产出，源文件: plugin-guides/bug-enchant-remover/commands.md -->
...
| **异常附魔数** | 命中关键词的附魔总数 |
| **识别为自定义物品** | 是否触发 GUI 道具保护（详见 [配置参考](https://miragedge.top/plugin-guides/bug-enchant-remover/config)） |
