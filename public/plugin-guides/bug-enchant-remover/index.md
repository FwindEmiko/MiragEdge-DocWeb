<!-- 来源页面: https://miragedge.top/plugin-guides/bug-enchant-remover -->
<!-- 由 llms.txt 标准生成器自动产出，源文件: plugin-guides/bug-enchant-remover/index.md -->

# BugEnchantRemover 使用文档
...
4. 按需编辑 `config.yml`（参考 [配置参考](https://miragedge.top/plugin-guides/bug-enchant-remover/config)）
...
详细命令说明见 [命令参考](https://miragedge.top/plugin-guides/bug-enchant-remover/commands)。
...
- [命令参考](https://miragedge.top/plugin-guides/bug-enchant-remover/commands) — 三条命令的完整说明
- [配置参考](https://miragedge.top/plugin-guides/bug-enchant-remover/config) — 所有配置项的详细解释
- [实战场景](https://miragedge.top/plugin-guides/bug-enchant-remover/scenarios) — 常见数据包异常的配置示例
- [UberEnchant 兼容](https://miragedge.top/plugin-guides/bug-enchant-remover/uber_enchant) — v1.3 新特性详解
