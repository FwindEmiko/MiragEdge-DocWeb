<!-- 来源页面: https://miragedge.top/plugin-guides/bug-enchant-remover/config -->
<!-- 由 llms.txt 标准生成器自动产出，源文件: plugin-guides/bug-enchant-remover/config.md -->
...
完整的 UberEnchant 附魔 ID 列表见 [UberEnchant 兼容](https://miragedge.top/plugin-guides/bug-enchant-remover/uber_enchant)。
