<!-- 来源页面: https://miragedge.top/plugin-guides/bug-enchant-remover/scenarios -->
<!-- 由 llms.txt 标准生成器自动产出，源文件: plugin-guides/bug-enchant-remover/scenarios.md -->
...
1. 用 UberEnchant 命令 `/ue give  blindness 3` 给自己一个带附魔的物品
...
参见 [UberEnchant 兼容 — 附魔清单](https://miragedge.top/plugin-guides/bug-enchant-remover/uber_enchant#附魔清单)。
