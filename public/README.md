<!-- 来源页面: https://miragedge.top/README -->
<!-- 由 llms.txt 标准生成器自动产出，源文件: README.md -->

# 锐界幻境文档站 · MiragEdge Docs

## 项目介绍

锐界幻境（MiragEdge）是基于高版本Minecraft（Java 26.2）的跨平台互通服务器，支持Java版与基岩版玩家同服游玩。本仓库是服务器官方文档库，涵盖**玩家指南**、**开发协作**、**版本日志**等核心内容，旨在帮助玩家快速上手、开发者高效协作，同时记录服务器的成长历程。
...
## 文档结构
文档按功能模块分类，主要包含：
- **新手引导**：客户端安装、入服教程、基础玩法（[查看](https://miragedge.top/manual/review.md)）
- **功能玩法**：装备升级、高级附魔、食物系统、工作系统（[查看](https://miragedge.top/features/index.md)）
- **开发协作**：内容设计流程、团队协作规范（[查看](https://miragedge.top/develop/team.md)）
- **版本日志**：游戏更新（功能优化/BUG修复）与网站迭代（界面/内容更新）（[查看](https://miragedge.top/develop/logs.md)）
- **规则说明**：玩家守则、交流群规范（[查看](https://miragedge.top/manual/eula.md)）
...
- **开发文档**：查看[开发文档](https://miragedge.top/develop/team.md)了解插件开发与系统架构
- **社区支持**：加入QQ群获取实时帮助
