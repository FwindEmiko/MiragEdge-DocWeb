...
<FoodEntry
  ...
  :hunger="10"
  :saturation="15.0"
  effect="30秒力量 II + 40秒暴击伤害 +100%。2分钟冷却。"
...
<FoodEntry
  ...
  :hunger="16"
  :saturation="18.0"
  effect="5秒饱和 + 45秒生命恢复 + 30秒抗性 I。当前饱食度超过 18 时额外获得 2点伤害吸收。"
...
<FoodEntry
  ...
  :hunger="8"
  :saturation="7.0"
  effect="食用后 20秒内每 4秒自动向面前喷出火焰，点燃 3格锥形范围内生物 3秒并造成 2点伤害。"
...
<FoodEntry
  ...
  :hunger="9"
  :saturation="14.0"
  effect="30秒内自身每秒受到 1点火焰伤害但生命恢复 II 持续抵消，近战攻击你的生物被点燃 5秒。配合抗火药水可实现无伤反伤。"
